...
<spring:form action="receptionistForm" method="post" modelAttribute="rmodel">
<table>	
<div class="container">
  <div class="title">Add Receptionist Data</div>
  <p> ${message} </p>
  <div class="sub-container">
   ...
   <div class="form">
    ...
    <div class="form">
      ...
      <input type="text" class="input" name="emailid" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" placeholder="example@email.com" required>
    </div>
