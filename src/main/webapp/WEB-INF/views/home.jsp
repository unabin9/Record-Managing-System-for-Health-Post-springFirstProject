...
<div class="dropdown1">
 <a href="${pageContext.request.contextPath}/receptionistLoginform">Receptionist Login</a>
 <a href="${pageContext.request.contextPath}/doctorLoginform">Doctor Login</a>
    ...
    <div id="absoluteCenteredDiv">
        <form action="adminlogin" method="post">
            <div class="box">
                ...
                <input class="username" name="loginid" type="text" placeholder="User Name" data-validate = "Username is reauired" required>
                <input class="username" name="password" type="password" placeholder="Password" data-validate = "Password is reauired" required>
