 ...
 <link href='resources/cssmenu/styles.css' rel='stylesheet'>
  ...
  <div class="dropdown"> 
   ...
   <div class="dropdown1">
    ...
    <div class="dropdown-content1">
      <a href="${pageContext.request.contextPath}/readOnlyAppointmentData">Appointment List</a>
    </div>	
  </div> 
  ...
  <div class="dropdown1">
    ...
    <div class="dropdown-content1">
      <a href="${pageContext.request.contextPath}/readOnlyPatientData">Patient List</a>
    </div>	
  </div>
</div> 
</div> 
