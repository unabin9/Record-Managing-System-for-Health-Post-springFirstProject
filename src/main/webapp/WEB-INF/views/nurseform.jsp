...
<spring:form action="nurseForm" method="post" modelAttribute="nmodel">
<table>	
<div class="container">
  <div class="title">Add Nurse Data</div>
  <p> ${message} </p>
  <div class="sub-container">
   ...
   <div class="form">
      ...
      <textarea class="input" name="qualification" rows="4" cols="8" required></textarea>
   </div>
