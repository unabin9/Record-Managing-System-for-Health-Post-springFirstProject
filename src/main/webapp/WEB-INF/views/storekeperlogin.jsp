...
<body style="background-image:url(resources/cssmenu/bg.jpg); background-position: center;
  ...
  <h1 style="color:#FFD700;font-style:inherit; font-size:xx-large; text-decoration: underline;">HOSPITAL MANAGENENT SYSTEM</h1>
    <div id="absoluteCenteredDiv">
        <form action="storekeperLoginform" method="post">
            <div class="box">
                <h1>StoreKeper Login</h1>
                <P style="color:pink; font-size:large;">${error}</P>
                <input class="username" name="loginid" type="text" placeholder="User Name" required>
